...
function init(ctx) {
  ...
  loop.updateVisualisation = function updateVisualisation (sbx) {
	...
	var eventualBGscaled = sbx.settings.units === 'mmol' ? 10 : eventualBG;
        var maxBGscaled = sbx.settings.units === 'mmol' ? 10 : maxBG;
        var minBGscaled = sbx.settings.units === 'mmol' ? 10 : minBG;
        valueParts = valueParts.concat([
